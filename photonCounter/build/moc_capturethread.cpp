...
QT_MOC_LITERAL(1, 14, 11), // "packetCount"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 5) // "count"

    },
    "CaptureThread\0packetCount\0\0count"
};
...
void CaptureThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->packetCount((*reinterpret_cast< int(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&CaptureThread::packetCount)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void CaptureThread::packetCount(int _t1)
{
